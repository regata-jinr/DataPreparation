...
namespace DataPreporation
{
    ...
    { 
        public static void Parse()
        {
            ...
            var finalDict = new Dictionary<string, List<double>>();
            ...
            using (TextWriter writer = File.AppendText(@"D:\GoogleDrive\Job\flnp\data\combinedStandards.csv"))
            {
            ...
            foreach (var file in files)
            {
                ...
                // if (!file.Contains("Pavlov_7005058")) continue;
                ...
                foreach (var line in lines)
                {
                    ...
                    if (startEnergyArea)
                    {
                        ...
                        //TODO: save fileName srmName nuclid energy to file
                    ...
                    if (startActivityArea)
                    {
                        ...
                        try
                        {
                            finalDict.Add(fdKey, new List<double> { req, activity, err });
                        }
                    ...
                    if (startMDAArea)
                    {
                        ...
                        if (finalDict.ContainsKey(fdKey)) finalDict[fdKey].Add(mda);
                    }
                ...
                finalDict.Clear();
                //  if (bcnt - FileList.Count == 10) break;
        ...
        //                }
        //                else if (fl.Length == 0) { Console.WriteLine($"File not found: {fileName}"); continue; }
